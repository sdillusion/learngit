...
public:
	...
	//bool ycGroupquery(const std::string& sqlStr);
	//bool yxGroupquery(const std::string& sqlStr);
	//bool ddGroupquery(const std::string& sqlStr);
	...
	bool ycQuery(char* bigid, char* groupid, int ycssindex);
	bool yxQuery(char* bigid, char* groupid, int yxssindex);
	bool ddQuery(char* bigid, char* groupid, int ddssindex);

	void bigResultFormat(int nrownum, int ncolnum, char **azResult);
	void ycGroupResultFormat(int nrownum, int ncolnum, char **azResult);
	void yxGroupResultFormat(int nrownum, int ncolnum, char **azResult);
	void ddGroupResultFormat(int nrownum, int ncolnum, char **azResult);
	void ycResultFormat(int nrownum, int ncolnum, char **azResult, int ycssindex);
	void yxResultFormat(int nrownum, int ncolnum, char **azResult, int yxssindex);
	void ddResultFormat(int nrownum, int ncolnum, char **azResult, int ddssindex);
